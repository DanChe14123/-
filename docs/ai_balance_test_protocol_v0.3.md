...
- 当前规则：`C:\PKU\Term2\实验室安全作品大赛\boardgame_v0.3.md`
- 规则归档：`C:\PKU\Term2\实验室安全作品大赛\versions\v0.3\boardgame_rules.md`
- 当前模拟器：`C:\PKU\Term2\实验室安全作品大赛\simulation\run_v0_3_balance.py`
- 模拟器归档：`C:\PKU\Term2\实验室安全作品大赛\versions\v0.3\run_balance_sim.py`
...
```powershell
python "C:\PKU\Term2\实验室安全作品大赛\simulation\run_v0_3_balance.py" `
  --games-per-team 3000 `
  --run-id run_XXX_description `
  --output-root "C:\PKU\Term2\实验室安全作品大赛\data\v0.3"
```
