...
TASKS: Tuple[Task, ...] = (
    ...
    Task("T02", "有机溶剂转移", ("hood", "shutdown", "label", "evacuate"), "clear_hazard", ("E05", "E06", "E16")),
    Task("T03", "加热回流", ("shutdown", "stop", "report", "emergency"), "reduce_upgrade", ("E06", "E12", "E14", "E15")),
    Task("T04", "废液分类处理", ("waste", "label", "cleanup", "evacuate"), "clear_hazard", ("E04", "E11", "E16")),
    Task("T05", "气瓶连接使用", ("secure", "inspect", "report"), "reduce_upgrade", ("E08", "E09", "E14")),
    Task("T06", "通风橱内称量与转移", ("hood", "cleanup", "label"), "gain_redraw", ("E03", "E05", "E10", "E16")),
    Task("T07", "清理实验台", ("cleanup", "waste", "inspect"), "recover_safety", ("E03", "E07", "E08")),
    Task("T08", "紧急情况报告与撤离", ("evacuate", "report", "emergency"), "control_choice", ("E11", "E13", "E15", "E16")),
    Task("T09", "危险化学品领用与登记", ("label", "report", "inspect"), "reduce_upgrade", ("E02", "E03", "E08")),
    Task("T10", "低温/高温设备使用", ("ppe", "shutdown", "emergency"), "recover_safety", ("E01", "E12", "E13")),
    Task("T11", "旋蒸或离心设备操作", ("inspect", "shutdown", "hood", "evacuate"), "gain_redraw", ("E05", "E08", "E14", "E16")),
    Task("T12", "实验结束后的交接检查", ("cleanup", "waste", "shutdown", "inspect"), "clear_hazard", ("E03", "E04", "E10", "E12")),
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run balance simulations for boardgame v0.6")
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=Path(r"C:\PKU\Term2\实验室安全作品大赛\data\v0.6"),
    )
