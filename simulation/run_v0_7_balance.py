...
TASKS: Tuple[Task, ...] = (
    ...
    Task("T07", "清理实验台", ("cleanup", "waste", "inspect"), "recover_safety", ("E03", "E07", "E08", "E23")),
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run balance simulations for boardgame v0.7")
    ...
    parser.add_argument(
        "--output-root",
        type=Path,
        default=Path(r"C:\PKU\Term2\实验室安全作品大赛\data\v0.7"),
    )
